...
public class OrderLogServiceImpl implements OrderLogService {
    ...
    public OrderLog queryOrderLog(String username, String orderid) {
        //查询日志订单映射信息->logId
        String orderLogId = (String) redisTemplate.boundHashOps("OrderMappingLog" + username).get(orderid);

        //根据logId查询日志信息
        return (OrderLog) redisTemplate.boundHashOps("OrderLog").get(orderLogId);
    }
