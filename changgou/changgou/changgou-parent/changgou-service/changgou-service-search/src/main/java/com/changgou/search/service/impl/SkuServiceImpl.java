...
public class SkuServiceImpl implements SkuService {
    ...
    public Map searhc(Map<String, String> searchMap) {
        ...
        //聚合查询
        resultMap.putAll(groupList(nativeSearchQueryBuilder,searchMap));
        return resultMap;
    }
     ...
     * @return
     */
    public List<String> getGroupData(Aggregations aggregations,String feildName){
        //根据别名获取分组数据
        StringTerms stringTerms = aggregations.get(feildName);
    ...
    public Map searchList(NativeSearchQueryBuilder nativeSearchQueryBuilder){
        ...
        //获取分页数据
        resultMap.put("pageNum",nativeSearchQuery.getPageable().getPageNumber()+1); //当前页
        resultMap.put("pageSize",nativeSearchQuery.getPageable().getPageSize());    //每页显示条数
        return resultMap;
    }
