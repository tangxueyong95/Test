...
由于这里的价格使用了中文`元`和`以上`,所以在`changgou-service-search`的搜索中需要去掉元和以上英文，修改`changgou-service-search`的`com.changgou.search.service.impl.SkuServiceImpl`
...
![1562724029292](images\1562724029292.png)
